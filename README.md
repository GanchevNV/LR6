...
<br>![Рисунок 1 - Аккаунт на GitHub](pic/1.png)<br>
...
<br>![Рисунок 2 - Добавление файлов через сайт](pic/2.png)<br>
Дальше, нужно вернуть в терминал и, чтобы была самая последняя версия проекта воспользоваться командой git pull.
<br>![Рисунок 3 - Обновление локального репозитория](pic/3.png)<br>
...
<br>![Рисунок 4 - Граф репозитория](pic/4.png)<br>
...
<br>![Рисунок 5 - Последний коммит у HEAD](pic/5.png)<br>
<br>![Рисунок 6 - Последний коммит у branch1](pic/6.png)<br>
...
<br>![Рисунок 7 - Представлени данных в branch1](pic/7.png)<br>
Теперь можно вернуться на основную векту и выполнить операцию слияния.
```bash
git checkout master
git merge branch1
```
<br>![Рисунок 8 - Ошибка слияния](pic/8.png)<br>
...
<br>![Рисунок 9 - Разрешение слияния](pic/9.png)<br>
...
<br>![Рисунок 10 - Разрешение слияния (граф)](pic/10.png)<br>
...
<br>![Рисунок 11 - До отката](pic/11.png)<br>
<br>![Рисунок 12 - После отката](pic/12.png)<br>
<br>![Рисунок 13 - Текст внутри файлов в коммитах](pic/13.png)<br>
...
<br>![Рисунок 14 - Загрузка на GitHub](pic/14.png)<br>
...
| Хеш | Автор | Время с коммита | Комментарий |
|-----|-------|-----------------|-------------|
| 3cb6044 | GanchevNV | 15 minutes ago | Обновление README.md |
| ed0c9c5 | 4417 Ганчев Никита | 21 minutes ago | Обновлённый отчёт |
| 9e2b969 | 4417 Ганчев Никита | 31 minutes ago | Добавил картинки |
| 90ad23c | 4417 Ганчев Никита | 47 minutes ago | Прототип README.md без картинок |
| e9d0bb7 | 4417 Ганчев Никита | 63 minutes ago | Создана ветка protocol |
| 38d82f0 | 4417 Ганчев Никита | 80 minutes ago | Новый файл test.txt |
| 725861c | 4417 Ганчев Никита | 2 hours ago | Конфликт разрешён |
| 6d26c9e | GanchevNV | 2 hours ago | Добавляем main.cpp |
| 921f53b | Kurtyanik | 5 years ago | Обновление информации |
| 0f9f50d | Kurtyanik | 5 years ago | Заполнил файл |
| c08a654 | Kurtyanik | 5 years ago | Файл создан пустым |
| 3c6e913 | Kurtyanik | 5 years ago | Initial commit |
